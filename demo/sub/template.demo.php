                ...
                <div class="card-body">
                    <fieldset class="compact-fieldset">
                        ...
                        foreach ($allFields as $field):
                            // Fremdschlüssel wird separat manuell ausgegeben, daher hier überspringen
                            ...
                            $showCheckbox = !$isContinentId && !in_array($field, $dateFields);
                            $checked = false;
                            if ($showCheckbox) {
                        ...
                        <?php foreach ($dateFields as $baseField): ?>
                            ...
                            // Individuelle Einheiten für dieses Feld aus $enrichedFields
